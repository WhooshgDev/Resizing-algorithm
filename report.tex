...
\begin{tabular}{ccc}
    ...
    \includegraphics[width=0.25\textwidth]{out_photo_hybrid.jpg} &
    \includegraphics[width=0.25\textwidth]{demo_hybrid.jpg} \\
...
\begin{tabular}{ccc}
    ...
    \includegraphics[width=0.18\textwidth]{out_photo_seam.jpg} &
    \includegraphics[width=0.18\textwidth]{out_photo_scale.jpg} \\
    Original & Seam carve & Scale \\
    \includegraphics[width=0.18\textwidth]{out_photo_crop.jpg} &
    \includegraphics[width=0.18\textwidth]{out_photo_letterbox.jpg} &
    \includegraphics[width=0.18\textwidth]{out_photo_hybrid.jpg} \\
...
\begin{tabular}{cc}
    ...
    \includegraphics[width=0.22\textwidth]{out_text_seam.jpg} \\
    Original text & Seam carve result \\
    \includegraphics[width=0.22\textwidth]{out_text_scale.jpg} &
    \includegraphics[width=0.22\textwidth]{out_text_hybrid.jpg} \\
...
\begin{tabular}{cc}
    ...
    \includegraphics[width=0.22\textwidth]{out_chart_seam.jpg} \\
    Original chart & Seam carve result \\
    \includegraphics[width=0.22\textwidth]{out_chart_scale.jpg} &
    \includegraphics[width=0.22\textwidth]{out_chart_hybrid.jpg} \\
    Scale result & Adaptive hybrid result
\end{tabular}
